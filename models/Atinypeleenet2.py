...
class DenseBlock(nn.Module):
    def __init__(self, inp, inter_channel):
        ...
        self.cb_c = Conv_bn_relu(inter_channel, inter_channel, 1, 1, 0, use_relu=False)
        self.cb_d = ConvDW_bn_relu(inter_channel, 3, 1, 1)
    ...
    def forward(self, x):
        ...
        out = torch.cat((x, cb_b_out, cb_d_out), 1)

...
from data import VOCroot, COCOroot, VOC_300, VOC_320, VOC_512, COCO_300, COCO_320, COCO_512, COCO_mobile_300, VOC_pelee_320,\
    AnnotationTransform, COCODetection, VOCDetection, detection_collate, BaseTransform, preproc
...
parser.add_argument('-v', '--version', default='SSD_vgg',
                    help='RFB_vgg ,RFB_E_vgg RFB_mobile SSD_vgg SSD_peleenet SSD_Apelee SSD_tinypelee SSD_Atinypelee SSD_ADtinypelee SSD_AD2tinypelee SSD_ATpelee SSD_ALpelee version.')
parser.add_argument('-s', '--size', default='300',
                    type=int, help='300 or 320 or 512 or 800 input size.')
parser.add_argument('-d', '--dataset', default='VOC',
                    help='VOC or COCO dataset')
parser.add_argument(
    '--basenet', default='weights/ATpelee/vgg16_reducedfc.pth', help='pretrained base model')
...
parser.add_argument('--resume_epoch', default=580,
...
parser.add_argument('-we', '--warm_epoch', default=11,
                    type=int, help='max epoch for retraining')
parser.add_argument('--gamma', default=0.1,
                    type=float, help='Gamma update for SGD')
parser.add_argument('--log_iters', default=True,
                    type=bool, help='Print the loss at each iteration')
parser.add_argument('--save_folder', default='weights/ALpelee/',
                    help='Location to save checkpoint models')
parser.add_argument('--date', default='20190220')
...
if args.version == 'RFB_vgg':
    ...
    cfg = VOC_pelee_320
elif args.version == 'SSD_Apelee':
    from models.APelee import build_net
elif args.version == 'SSD_tinypelee':
    from models.Tiny_pelee import build_net
elif args.version == 'SSD_Atinypelee':
    from models.ATiny_pelee import build_net
elif args.version == 'SSD_ADtinypelee':
    from models.ADTiny_pelee import build_net
elif args.version == 'SSD_AD2tinypelee':
    from models.AD2Tiny_pelee import build_net  
elif args.version == 'SSD_ATpelee':
    from models.ATpelee import build_net
...
max_epoch = (1600, 360)[args.dataset == 'COCO']
...
def train():
    ...
    stepvalues_VOC = (400 * epoch_size, 800 * epoch_size, 1200 * epoch_size)
    stepvalues_COCO = (86 * epoch_size, 152 * epoch_size, 218 * epoch_size, 284 * epoch_size, 350 * epoch_size)
    ...
    for iteration in range(start_iter, max_iter + 10):
        if (iteration % epoch_size == 0):
            ...
            if epoch % args.test_frequency == 0 and epoch > 0:
                net.eval()
                top_k = (400, 200)[args.dataset == 'COCO']
                if args.dataset == 'VOC':
                    ...
                    writer.add_scalar('val_acc',mAP,iteration)
                    mAP = str(mAP)
...
def test_net(save_folder, net, detector, cuda, testset, transform, max_per_image=300, thresh=0.005):
    ...
    if Avg_time != 0:
        FPS = 1.0 / Avg_time
        print('average detection time: {:.3f}s FPS: {:.3f}'
                .format(Avg_time, FPS))
